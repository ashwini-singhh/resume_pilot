...
const steps = [
  {
    ...
    desc: 'Drop your PDF or Word document. Our AI reads it instantly.',
    color: '#8b5cf6',
  },
  {
    num: '02',
    ...
    desc: 'Receive an instant match score and section-level analysis.',
    color: '#0052FF',
  },
  {
    num: '03',
    ...
    desc: 'Paste a job description to see exactly where your gaps are.',
    color: '#f59e0b',
  },
  {
    num: '04',
    ...
    desc: "Follow AI suggestions to fix gaps and apply with confidence.",
    color: '#22c55e',
  },
];
